...
def burch_cold_water(external_factors: ExternalFactors) -> pd.DataFrame:
    ...
    **Overview**
    ...
    cold_water_temperature_F = (
        external_temperature_F.mean()
        + 3
        ...
        * np.sin(
            ...
            * (
                0.986
                * (
                    external_temperature_F.index.dayofyear
                    - coldest_dayofyear
                    - (35 - (external_temperature_F.mean() - 44))
                )
                - 90
            )
        )
    ...
    cold_water_temperature = pd.Series(
        convert_serie_F_to_C(cold_water_temperature_F),
        name=COLD_WATER_TEMPERATURE_NAME,
